...
namespace Login
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="Login.LoginCMS")]
    public interface LoginCMS
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.FaultContractAttribute(typeof(Login.LoginFault), Action="", Name="fault")]
        Login.loginCmsResponse loginCms(Login.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<Login.loginCmsResponse> loginCmsAsync(Login.loginCmsRequest request);
    }
    ...
    public partial class loginCmsRequest
    {
        ...
        public Login.loginCmsRequestBody Body;
        
        public loginCmsRequest()
        {
        }
        
        public loginCmsRequest(Login.loginCmsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class loginCmsResponse
    {
        ...
        public Login.loginCmsResponseBody Body;
        
        public loginCmsResponse()
        {
        }
        
        public loginCmsResponse(Login.loginCmsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface LoginCMSChannel : Login.LoginCMS, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<Login.LoginCMS>, Login.LoginCMS
    {
        ...
        public Login.loginCmsResponse loginCms(Login.loginCmsRequest request)
        {
            return base.Channel.loginCms(request);
        }
        
        public System.Threading.Tasks.Task<Login.loginCmsResponse> loginCmsAsync(Login.loginCmsRequest request)
        {
